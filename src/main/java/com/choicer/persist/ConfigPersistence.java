...
/**
 * Mirrors Chocier state into RuneLite ConfigManager so it can sync across
 * machines
...
public final class ConfigPersistence {
    private static final String GROUP = "choicer";
    ...
    private static String dataKey(String key, String player) {
        return key + "." + player + DATA_SUFFIX;
    }

    private static String tsKey(String key, String player) {
        return key + "." + player + TS_SUFFIX;
    }
